...
//    //Поскольку поля константы(не меняют своего значения) возможно реализовать только пустой конструктор!!!
...
////Поскольку поле константа, то установить новое значение не возможно.
