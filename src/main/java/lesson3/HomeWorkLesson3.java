...
public class HomeWorkLesson3 {
    ...
    public static void main(String[] args) {
         ...
         /*1. Используя класс Scanner, написать программу, которая будет запрашивать пользователя
...
*/
        ...
        System.out.println(askAbout + " " + aboutMe);

//        Реализация в отделном классе.
...
*/
        ...
        SupportMethods calc = new SupportMethods();
        int first = 10;
        ...
        System.out.println("Результат деления: " + SupportMethods.calcDiv(firstDoub, 4.5, 5.5));//Static

        System.out.println("Результат умножения: " + SupportMethods.calcMultiplic(firstDoub, 4.5, 5.5));//Static
